...
# 첫 줄 예시: maintenance_status overall=healthy ops_gate_code=0 collector_mode=live fast_cap_reason="not_initialized" delivery_failures=0 primary_issue="none" recommended_action="none"
